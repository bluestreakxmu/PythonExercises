...
from ColorWall.wall import Wall
import ColorWall.effects as effects

if __name__ == "__main__":  # 表示该模块由用户独立运行
    ...
    if args.effects:
        effects_to_run = [getattr(effects, a) for a in args.effects if hasattr(effects, a)]
    else:
